...
public class BankAccountTests {
    ...
    public void shouldContainFieldBalance() {
        ...
        boolean isInt = f.getType().getName().equals("int");
        boolean isBigDecimal = f.getType().getName().equals("java.math.BigDecimal");
        assertTrue("Field balance should be an int (or BigDecimal)", isInt || isBigDecimal);
    }
