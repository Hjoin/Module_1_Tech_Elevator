...
public class Exercises {
	...
	public String theEnd(String str, boolean front) {
		String oneLetter = "";
		if (front == true) {
			oneLetter = str.substring(0, 1);
		} else {
			oneLetter = str.substring(str.length() - 1);
		}
		return oneLetter;
	}
	...
	public boolean hasBad(String str) {
		if (str.length() > 3 && (str.substring(0, 3).equals("bad") || str.substring(1, 4).equals("bad"))) {
			return true;
		} else if (str.length() == 3 && str.substring(0).equals("bad")) {
			return true;
		}
			return false;
	...
	public String frontTimes(String str, int n) {
		...
		if (str.length() < 3) {
			...
			for (int i = 0; i < n; i++) {
				repeatedString += str.substring(0, 3);
	...
	public boolean doubleX(String str) {
		boolean xTimesTwo = false;
		int indexOfX = str.indexOf("x");
		if (indexOfX < 0 || indexOfX == str.length() - 1) {
			xTimesTwo = false;
		} else {
			xTimesTwo = str.substring(indexOfX, indexOfX + 2).equals("xx");
		}
		return xTimesTwo;
	}
	...
	public String stringSplosion(String str) {
		...
		for (int i = 0; i <= str.length(); i++) {
			...
			placeHolder = newString.toString();
		}
		return placeHolder;
	}
	...
	public int last2(String str) {
		...
		if (str.length() < 2) {
			...
			String tinyWord = str.substring(i, i + 2);
			if (tinyWord.equals(str.substring(str.length() - 2))) {
				instancesOf ++;
			}
		}
		return instancesOf;
	...
	public String stringX(String str) {
		if (str.length() <= 2) {
			...
			return firstValue + str + lastValue;
		}
	}
