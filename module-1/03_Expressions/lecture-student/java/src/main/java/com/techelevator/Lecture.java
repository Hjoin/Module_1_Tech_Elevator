...
public class Lecture {
    ...
    */
    public boolean returnTrueWhenGreaterThanFive(int number) {
        boolean resultOfGreaterNumber = false;
        if (number > 5) {
            resultOfGreaterNumber = true;

        } else {
            resultOfGreaterNumber = false;

        }
        return resultOfGreaterNumber;
    }
    ...
    */
    public String returnAdultOrMinorOrTeen(int number) {
        if (number >= 18) {
            return "Adult";
        } else if (number >= 13 ){ //&& number <= 17//) -Not needed because repetitive
            return "Teen";
        } else {
            return "Minor";
        }
